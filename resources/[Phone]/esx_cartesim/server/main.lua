...
AddEventHandler('esx_cartesim:sim_give', function (store, index)
  ...
  TriggerClientEvent('esx:showNotification', id, "Vous avez pris la carte SIM~o~" .. simZ)
...
ESX.RegisterServerCallback('esx_cartesim:GetList', function(source, cb)
	...
	MySQL.Async.fetchAll("SELECT * FROM sim WHERE identifier=@identifier",{['@identifier'] = xPlayer.identifier}, function(data) 
