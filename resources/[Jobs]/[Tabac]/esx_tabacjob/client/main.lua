...
function IsJobTrue()
  if PlayerData ~= nil then
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'tabac' or PlayerData.job2 ~= nil and PlayerData.job2.name == 'tabac' then
      IsJobTrue = true
    end
    return IsJobTrue
  end
...
function OpenTabacActionsMenu()
  ...
  if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name ~= 'recrue' or PlayerData.job2 ~= nil and PlayerData.job2.grade_name ~= 'recrue' then
  	table.insert(elements, {label = _U('withdraw_stock'), value = 'get_stock'})
  end

  if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' or PlayerData.job2 ~= nil and PlayerData.job2.grade_name == 'boss' then
...
function OpenTabacHarvestMenu()
  ...
  if Config.EnablePlayerManagement and PlayerData.job ~= nil or PlayerData.job2 ~= nil then
    local elements = {
