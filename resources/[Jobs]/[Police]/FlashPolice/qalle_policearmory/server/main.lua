...
AddEventHandler("qalle_policearmory:giveWeapon", function(weapon)
    ...
    if player then
        player.addWeapon(weapon, Config.ArmoryP.ReceiveAmmo)

        TriggerClientEvent("esx:showNotification", source, "Vous venez de recevoir 1x " .. ESX.GetWeaponLabel(weapon) .. " avec " .. Config.ArmoryP.ReceiveAmmo .. "x ammo.")
    end
end)