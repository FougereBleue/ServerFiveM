Config = {
    ...
    Items = {
        ["drinks"] = {
            ...
            {label = "Evian fraise", item = "evian", price = 10},
        },
        ["snacks"] = {
            {label = "Chips au fromage", item = "cheesebows", price = 12},
            {label = "Chips Lays", item = "chips", price = 12},
            {label = "Lait chocolaté", item = "chocolatemilk", price = 12},
        },
        ["readymeal"] = {
            {label = "Pizza", item = "pizza", price = 30},
            {label = "Cheese Burger", item = "burger", price = 27},
            {label = "Pâtes Carbonara", item = "pastacarbonara", price = 18},
            {label = "Sandwich au Jambon", item = "sandwich", price = 8},
        },
        ["diverse"] = {
            {label = "Carte Sim", item = "sim", price = 50},
            {label = "Briquet", item = "lighter", price = 20},
            {label = "Ticket de loto", item = "lotteryticket", price = 20},
        },
    },
}