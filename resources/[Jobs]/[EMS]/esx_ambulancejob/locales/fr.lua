Locales['fr'] = {
  ...
  ['open_pharmacy'] = '~r~appuyez sur [~g~E~r~] pour ouvrir la ~b~pharmacie.',
  ['pharmacy_menu_title'] = 'Pharmacie',
  ['pharmacy_take'] = 'prendre <span style="color:red;">%s</span>',
  ['medikit'] = 'kit de soin',
  ['bandage'] = 'bandage',
  ...
  ['ems_menu_outthecar'] = '🚑sortir du véhicule',
  ['ems_menu_small'] = '❤️soigner petites blessures',
  ['ems_menu_big'] = '💕soigner blessures graves',
  ['Menu Coéquipier'] = '👩‍⚕️ Menu Coéquipier',
  ['ems_menu_small1'] = '🐻‍ Menu Chien',
  -- Phone
