...
function OpenMobileAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		elements = {
			...
			{label = '<span style="color:blue;">🚑EMS En Pause<span style="color:white;">', value = 'ems_pause'},
			--[[ {label = '<span style="color:yellow;">👩‍⚕️EMS Coéquipier<span style="color:white;">', value = 'ambulancecop'},
			{label = '<span style="color:brown;">🐻‍Chien Ambulancier<span style="color:white;">', value = 'policedog'}, ]]
		}
	}, function(data, menu)
		--[[ if data.current.value == 'ambulancecop' then
            TriggerEvent('esx_ambulancecop:openMenu')
		end

		if data.current.value == 'policedog' then
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		elseif data.current.action == 'garage' then
			...
			ESX.TriggerServerCallback('esx_vehicleshop:retrieveJobVehicles', function(jobVehicles)
				print("WAIT WHATTTTTT????"..#jobVehicles)
