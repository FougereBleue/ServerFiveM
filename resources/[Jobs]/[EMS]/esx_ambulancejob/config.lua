...
Config.RespawnPoint = { coords = vector3(311.21, -578.48, 43.28), heading = 199.43 }
Config.UnityX = { x= 311.21, y= -578.48, z= 43.28, heading = 199.43 }
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(299.70, -584.88, 43.28),
			sprite = 61,
			scale  = 0.8,
			color  = 2
		},
		...
		AmbulanceActions = {
			vector3(301.53, -599.01, 43.28)
		},

		Pharmacies = {
			vector3(311.05, -565.89, 43.28)
		},

		Vehicles = {
			{
				Spawner = vector3(300.01, -602.95, 43.37),
				InsideShop = vector3(342.181, -558.66, 28.7),
				Marker = { type = 36, x = 1.0, y = 1.0, z = 1.0, r = 100, g = 50, b = 200, a = 100, rotate = true },
				SpawnPoints = {
					{ coords = vector3(296.76, -607.75, 42.45), heading =  245.45, radius = 4.0 },
					{ coords = vector3(294.86, -582.04, 43.175), heading = 7.83, radius = 4.0 },
					{ coords = vector3(333.68, -623.40, 28.39), heading = 243.77, radius = 6.0 }
				}
			}
		},
