...
local blips = {
	...
	{title="Benny's", colour=-1, id=446, x =-207.026, y = -1321.208, z = 38.89,}, -- Location to obtain supplies needed to make cocaine at Drug Processing Location
  }
...
function OpenMobilegrooveActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_groove_actions', {
		...
		elements = {
			...
			{label = 'Appeler un Mécano',       value = 'meca1'},					
			{label = _U('hijack'),        value = 'hijack_vehicle'},
			{label = 'Réparation Moto/Camion',        value = 'fix_vehicle'},
			{label = 'Réparation Voiture',        value = 'fix_vehicle1'},	
			{label = 'Réparation Roue',        value = 'fix_wheel'},			
	...
	elseif data.current.value == 'clean_vehicle' then
		...
		if DoesEntityExist(vehicle) then
			...
			Citizen.CreateThread(function()
				exports['progressBars']:startUI(10000, "Nettoyage")
				Citizen.Wait(10000)
	...
	elseif data.current.value == 'object_spawner' then
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_groove_actions_spawn', {
			...
			elements = {
				...
				{label = 'Répartion', value = 'imp_prop_impexp_postlift'},			
				{label = 'Mur Roue', value = 'imp_prop_impexp_hub_rack_01a'},				
				{label = 'Chaise', value = 'v_ret_gc_chair02'},			
