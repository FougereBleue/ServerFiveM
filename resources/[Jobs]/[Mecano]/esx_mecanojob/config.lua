...
Config.Zones = {
	...
	grooveActions = {
		Pos = {x = -197.93, y = -1341.33, z = 33.899},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 700, g = 200, b = 0 },
		Type  = 21,
	},
	...
	Craft = {
		Pos = {x = -196.66, y = -1318.390, z = 30.189},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 700, g = 200, b = 0 },
		Type  = 21,
	},
	...
	VehicleSpawnPoint = {
		Pos = {x = -189.25, y = -1286.45, z = 30.30},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos = { x = -161.42, y = -1303.776, z = 30.37},
	...
	VehicleDelivery = {
		Pos = {x = -181.60, y = -1310.13, z = 30.29},
		Size  = { x = 20.0, y = 20.0, z = 3.0 },
		Color = { r = 700, g = 200, b = 0 },
		Type  = -1,
	},
	BlipsInfo = {
		Pos = {x = -207.026, y = -1321.208, z = 38.89},
