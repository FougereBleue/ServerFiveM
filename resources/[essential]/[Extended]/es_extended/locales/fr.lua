Locales['fr'] = {
  ...
  ['noammo'] = 'Tu n\'as pas toutes ces munitions sur toi',
  ['gave_item'] = 'Vous venez de donné ~y~%sx~s~ ~b~%s~s~ à ~y~%s~s~',
  ['received_item'] = 'Vous venez de recevoir ~y~%sx~s~ ~b~%s~s~ par ~b~%s~s~',
  ['gave_weapon'] = 'Vous venez de donné ~y~1x~s~ ~b~%s~s~ à ~y~%s~s~',
  ['gave_weapon_ammo'] = 'Vous venez de donné ~o~%sx %s~s~ pour ~b~%s~s~ à ~y~%s~s~',
  ['gave_weapon_withammo'] = 'Vous venez de donné ~y~1x~s~ ~b~%s~s~ avec ~o~%sx %s~s~ à ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ a déjà ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ n\'a pas cette arme',
  ['received_weapon'] = 'Vous venez de recevoir ~y~1x~s~ ~b~%s~s~ de ~b~%s~s~',
  ...
  ['gave_account_money'] = 'Vous venez de donné ~g~$%s~s~ (%s) à ~y~%s~s~',
  ['received_account_money'] = 'Vous venez de recevoir ~g~$%s~s~ (%s) par ~b~%s~s~',
  ['amount_invalid'] = 'Montant invalide',
  ['players_nearby'] = 'Aucun joueur à proximité',
  ['ex_inv_lim'] = 'Action impossible, dépassement de la limite d\'inventaire pour ~y~%s~s~',
  ['imp_invalid_quantity'] = 'Action impossible, ~r~quantité invalide',
  ['imp_invalid_amount'] = 'Action impossible, ~r~montant invalide',
  ['threw_standard'] = 'Vous venez de jeté ~y~%sx~s~ ~b~%s~s~',
  ['threw_account'] = 'Vous venez de ~g~$%s~s~ ~b~%s~s~',
  ['threw_weapon'] = 'Vous venez de ~y~1x~s~ ~b~%s~s~',
  ['threw_weapon_ammo'] = 'Vous venez de ~y~1x~s~ ~b~%s~s~ avec ~o~%sx %s~s~',
  ['threw_weapon_already'] = 'Vous portez déjà cette arme sur vous',
  ...
  ['received_salary'] = 'Vous venez de recevoir votre salaire: ~g~$%s~s~',
  ['received_help'] = 'Vous venez de recevoir une aide de l\'état: ~g~$%s~s~',
  ['company_nomoney'] = 'Malheureusement votre P.D.G n\'a plus de sous pour vous payer!',
  ...
  ['component_luxary_finish'] = 'Finition type luxe',
