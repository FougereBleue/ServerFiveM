function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, weight, job, org, loadout, name, coords, inService)
	local self = {}
	...
	self.getInService = function()
		return self.inService
	end

	self.setInService = function(newInService)
		self.inService = newInService
	end
