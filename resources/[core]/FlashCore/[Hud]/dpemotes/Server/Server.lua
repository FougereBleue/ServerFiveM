...
if Config.SqlKeybinding then
  MySQL.ready(function()
	...
	AddEventHandler("dp:ServerKeybindCreate", function()
		...
		{id = srcid, keybind1 = "num1", emote1 = "", keybind2 = "num2", emote2 = "", keybind3 = "num3", emote3 = "", keybind4 = "num4", emote4 = "", keybind5 = "num5", emote5 = "", keybind6 = "num6", emote6 = "", keybind7 = "num7", emote7 = "", keybind8 = "num8", emote8 = "", keybind9 = "num9", emote9 = ""}, function(created) print("[dp] ^2"..GetPlayerName(src).."^7 got created!") TriggerClientEvent("dp:ClientKeybindGet", src, "num1", "", "num2", "", "num3", "", "num4", "", "num5", "", "num6", "", "num7", "", "num8", "", "num9", "") end)
	end)
	...
	AddEventHandler("dp:ServerKeybindGrab", function()
		...
		{['@id'] = srcid}, function(kb)
			if kb[1].keybind1 ~= nil then
				...
				TriggerClientEvent("dp:ClientKeybindGet", src, "num1", "", "num2", "", "num3", "", "num4", "", "num5", "", "num6", "", "num7", "", "num8", "", "num9", "")
			end
		end)
	end)
	...
	AddEventHandler("dp:ServerKeybindUpdate", function(key, emote)
		...
		if key == "num1" then chosenk = "keybind1" elseif key == "num2" then chosenk = "keybind2" elseif key == "num3" then chosenk = "keybind3" elseif key == "num4" then chosenk = "keybind4" elseif key == "num5" then chosenk = "keybind5" elseif key == "num6" then chosenk = "keybind6" elseif key == "num7" then chosenk = "keybind7" elseif key == "num8" then chosenk = "keybind8" elseif key == "num9" then chosenk = "keybind9" end
