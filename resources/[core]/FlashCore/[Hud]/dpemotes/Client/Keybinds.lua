...
AddEventHandler("dp:ClientKeybindGetOne", function(key, e)
	...
	if key == "num1" then emob1 = e keyb1 = "num1" elseif key == "num2" then emob2 = e keyb2 = "num2" elseif key == "num3" then emob3 = e keyb3 = "num3" elseif key == "num4" then emob4 = e keyb4 = "num4" elseif key == "num5" then emob5 = e keyb5 = "num5" elseif key == "num6" then emob6 = e keyb6 = "num6" elseif key == "num7" then emob7 = e keyb7 = "num7" elseif key == "num8" then emob8 = e keyb8 = "num8" elseif key == "num9" then emob9 = e keyb9 = "num9" end
end)
