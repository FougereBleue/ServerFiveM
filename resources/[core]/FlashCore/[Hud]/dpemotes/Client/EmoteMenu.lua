...
mainMenu = NativeUI.CreateMenu("Flash RP", "", menuPosition["x"], menuPosition["y"], Menuthing, Menuthing)
...
function AddEmoteMenu(menu)
    ...
    if not Config.SqlKeybinding then
      ...
      keyinfo =  NativeUI.CreateItem(Config.Languages[lang]['keybinds'], Config.Languages[lang]['keybindsinfo'].." /emotebind [~y~num1-9~w~] [~g~emotename~w~]")
...
function AddWalkMenu(menu)
    ...
    WalkInjured = NativeUI.CreateItem("Blessée", "")
