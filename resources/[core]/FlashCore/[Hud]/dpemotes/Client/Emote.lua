...
Citizen.CreateThread(function()
    ...
    if Config.SqlKeybinding then
      TriggerEvent('chat:addSuggestion', '/emotebind', 'Bind an emote', {{ name="key", help="num1,num2,num3,num4, num5, num6, num7. num8, num9. Numpad 1-9!"}, { name="emotename", help="dance, camera, sit or any valid emote."}})
...
RegisterNetEvent('emotesmenu')
AddEventHandler('emotesmenu', function(source, args, raw)
	OpenEmoteMenu() 
end)