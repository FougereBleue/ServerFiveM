...
Config.Garages = {
    ...
    ["G"] = {
        ["positions"] = {
            ["menu"] = {
                ["position"] = vector3(-339.276, 267.283, 85.688),
                ["text"] = "[ ~o~E~s~ ] Garage",
            },
            ["vehicle"] = {
                ["position"] = vector3(-335.224, 279.561, 85.864), 
                ["heading"] = 172.30,
                ["text"] = "[ ~o~E~s~ ] Ranger le vehicule",
            }
        },
    ...
    ["H"] = {
        ["positions"] = {
            ["menu"] = {
                ["position"] = vector3(-283.004, -887.533, 31.080),
                ["text"] = "[ ~o~E~s~ ] Garage",
            },
            ["vehicle"] = {
                ["position"] = vector3(-300.766, -891.779, 31.080), 
                ["heading"] = 172.30,
                ["text"] = "[ ~o~E~s~ ] Ranger le vehicule",
            }
        },
    ...
    ["H"] = {
        ["positions"] = {
            ["menu"] = {
                ["position"] = vector3(-990.466, -2700.976, 13.830),
                ["text"] = "[ ~o~E~s~ ] Garage",
            },
            ["vehicle"] = {
                ["position"] = vector3(-973.315, -2703.850, 13.865), 
                ["heading"] = 172.30,
                ["text"] = "[ ~o~E~s~ ] Ranger le vehicule",
            }
        },
