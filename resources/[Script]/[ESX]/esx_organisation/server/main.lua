...
ESX.RegisterServerCallback('esx_organisation:getSocietyMoney', function(source, cb, organisationName)
	local organisation = GetOrganisation(organisationName)
...
ESX.RegisterServerCallback('esx_organisation:setOrgalary', function(source, cb, org, gradeorg, salary)
	local xPlayer = ESX.GetPlayerFromId(source)
	...
	if xPlayer.org.name == org and xPlayer.org.gradeorg_name == 'boss' then
		if salary <= Config.MaxSalary then
			...
			--print(('esx_organisation: %s attempted to setOrgalary over config limit!'):format(xPlayer.identifier))
			cb()
		end
	else
		--print(('esx_organisation: %s attempted to setOrgalary'):format(xPlayer.identifier))
		cb()
	end
end)
