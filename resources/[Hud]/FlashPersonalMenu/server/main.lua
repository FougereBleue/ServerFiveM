...
AddEventHandler('KorioZ-PersonalMenu:Boss_promouvoirplayer2', function(target)
	...
	if (targetXPlayer.org.gradeorg == maximumgrade) then
		...
		if (sourceXPlayer.org.name == targetXPlayer.org.name) then
			local grade2 = tonumber(targetXPlayer.org.gradeorg) + 1
			local org = targetXPlayer.org.name

			targetXPlayer.setOrg(org, grade2)
...
AddEventHandler('KorioZ-PersonalMenu:Boss_recruterplayer2', function(target, org, grade2)
	local _source = source
