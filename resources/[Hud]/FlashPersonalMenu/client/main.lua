...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	...
	if ESX.PlayerData.org ~= nil and ESX.PlayerData.org.gradeorg_name == 'boss' and 'organisation_' .. ESX.PlayerData.org.name == society then
		UpdateSociety2Money(money)
	end
end)
...
function AddMenuWalletMenu(menu)
	...
	if Config.doublejob then
		walletJob2 = NativeUI.CreateItem(_U('wallet_job2_button', ESX.PlayerData.org.label, ESX.PlayerData.org.gradeorg_label), "")
...
function addMenuAnimation2(menu)
	local saluerItem = NativeUI.CreateItem(_U('animation2_title'), "")
	menu:AddItem(saluerItem)
...
function AddSubMenuTestMenu(menu)
	animTestMenu = _menuPool:AddSubMenu(menu.SubMenu, _U('animation_Test_title'))

	local saluerItem = NativeUI.CreateItem(_U('animation_Test_saluate'), "")
	animTestMenu.SubMenu:AddItem(saluerItem)
	local militaryItem = NativeUI.CreateItem(_U('animation_Test_military'), "")
	animTestMenu.SubMenu:AddItem(militaryItem)
	local claquetteItem = NativeUI.CreateItem(_U('animation_Test_claquette'), "")
	animTestMenu.SubMenu:AddItem(claquetteItem)
	local danse1Item = NativeUI.CreateItem(_U('animation_Test_danse1'), "")
	animTestMenu.SubMenu:AddItem(danse1Item)
	local danse2Item = NativeUI.CreateItem(_U('animation_Test_danse2'), "")
	animTestMenu.SubMenu:AddItem(danse2Item)
	local danse3Item = NativeUI.CreateItem(_U('animation_Test_danse3'), "")
	animTestMenu.SubMenu:AddItem(danse3Item)
	local danse4Item = NativeUI.CreateItem(_U('animation_Test_danse4'), "")
	animTestMenu.SubMenu:AddItem(danse4Item)
	local danse5Item = NativeUI.CreateItem(_U('animation_Test_danse5'), "")
	animTestMenu.SubMenu:AddItem(danse5Item)
	local danse6Item = NativeUI.CreateItem(_U('animation_Test_danse6'), "")
	animTestMenu.SubMenu:AddItem(danse6Item)
	local danse7Item = NativeUI.CreateItem(_U('animation_Test_danse7'), "")
	animTestMenu.SubMenu:AddItem(danse7Item)
	local danse8Item = NativeUI.CreateItem(_U('animation_Test_danse8'), "")
	animTestMenu.SubMenu:AddItem(danse8Item)
	local danse9Item = NativeUI.CreateItem(_U('animation_Test_danse9'), "")
	animTestMenu.SubMenu:AddItem(danse9Item)
	local danse10Item = NativeUI.CreateItem(_U('animation_Test_danse10'), "")
	animTestMenu.SubMenu:AddItem(danse10Item)
	local danse11Item = NativeUI.CreateItem(_U('animation_Test_danse11'), "")
	animTestMenu.SubMenu:AddItem(danse11Item)
	local danse12Item = NativeUI.CreateItem(_U('animation_Test_danse12'), "")
	animTestMenu.SubMenu:AddItem(danse12Item)
	local danse13Item = NativeUI.CreateItem(_U('animation_Test_danse13'), "")
	animTestMenu.SubMenu:AddItem(danse13Item)
	local danse14Item = NativeUI.CreateItem(_U('animation_Test_danse14'), "")
	animTestMenu.SubMenu:AddItem(danse14Item)
	local danse15Item = NativeUI.CreateItem(_U('animation_Test_danse15'), "")
	animTestMenu.SubMenu:AddItem(danse15Item)
	local danse16Item = NativeUI.CreateItem(_U('animation_Test_danse16'), "")
	animTestMenu.SubMenu:AddItem(danse16Item)
	local danse17Item = NativeUI.CreateItem(_U('animation_Test_danse17'), "")
	animTestMenu.SubMenu:AddItem(danse17Item)
	local danse18Item = NativeUI.CreateItem(_U('animation_Test_danse18'), "")
	animTestMenu.SubMenu:AddItem(danse18Item)
	local danse19Item = NativeUI.CreateItem(_U('animation_Test_danse19'), "")
	animTestMenu.SubMenu:AddItem(danse19Item)
	local danse20Item = NativeUI.CreateItem(_U('animation_Test_danse20'), "")
	animTestMenu.SubMenu:AddItem(danse20Item)

	animTestMenu.SubMenu.OnItemSelect = function(sender, item, index)
		if item == saluerItem then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_09_v1_male^2")
		elseif item == militaryItem then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_09_v2_male^1")
		elseif item == claquetteItem then
			startAnim("special_ped@mountain_dancer@monologue_4@monologue_4a", "mnt_dnc_verse")	
		elseif item == danse1Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_09_v2_male^6")	
		elseif item == danse2Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_17_v1_male^3")
		elseif item == danse3Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_17_v2_male^2")
		elseif item == danse4Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "mi_dance_facedj_13_v2_male^6")
		elseif item == danse5Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "mi_dance_facedj_11_v1_male^5")
		elseif item == danse6Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "li_dance_facedj_09_v1_male^3")
		elseif item == danse7Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "li_dance_facedj_11_v1_male^6")
		elseif item == danse8Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_crowd_09_v2_male^3")
		elseif item == danse9Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_09_v1_male^4")
		elseif item == danse10Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_11_v2_male^6")
		elseif item == danse11Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_17_v2_male^2")
		elseif item == danse12Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_15_v2_male^1")
		elseif item == danse13Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_15_v2_female^5")
		elseif item == danse14Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_15_v2_female^1")
		elseif item == danse15Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_17_v2_male^6")
		elseif item == danse16Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_17_v2_male^3")
		elseif item == danse17Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_15_v2_male^2")
		elseif item == danse18Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_17_v2_male^3")
		elseif item == danse19Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_15_v1_male^1")
		elseif item == danse20Item then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_13_v1_male^2")																							
		end
	end
end
