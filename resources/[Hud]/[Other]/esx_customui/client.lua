...
Citizen.CreateThread(function()
  	...
  	AddTextEntry('FE_THDR_GTAO', '~y~FLASH RP ~t~| ~g~Discord: Ykxnkf~t~ | ~b~ID: ' .. GetPlayerServerId(PlayerId()) .. ' ~t~| ~r~Nom: ' .. (GetPlayerName(PlayerId())) .. '~r~');
...
AddEventHandler('esx:playerLoaded', function(xPlayer) 
	...
	SendNUIMessage({action = "setValue2", key = "org", value = org.label.." - "..org.gradeorg_label, icon2 = org.name})
