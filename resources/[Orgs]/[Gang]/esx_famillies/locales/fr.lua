Locales['fr'] = {
  ...
  ['being_searched'] = 'Une personne vous ~y~fouille~s~',
  -- Vehicle interaction
  ...
  ['famillies_stock'] = 'coffre des famillies',
  -- Boss Menu
  ['open_bosschest'] = 'appuyez sur ~INPUT_CONTEXT~ pour ouvrir le coffre',
  ['open_chest'] = 'appuyez sur ~INPUT_CONTEXT~ pour poser tous votre argent sale',
  ['quantity_invalid'] = 'quantité invalide',
  ['quantity'] = 'quantité',
  ['inventory'] = 'inventaire',
  ['famillies_stock'] = 'coffre de la famillies',
  -- Misc
  ...
  -- Notifications
  ['alert_famillies'] = 'alerte famillies',
  ['phone_famillies'] = 'famillies',
}
