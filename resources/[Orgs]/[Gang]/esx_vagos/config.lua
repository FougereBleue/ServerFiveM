...
Config.vagosStations = {
	...
	VAGOS = {
		...
		Blip = {
			Coords  = vector3(326.0007, -2032.8780, 20.45),
			Sprite  = 429,
			Display = 4,
			Scale   = 1.2,
			Colour  = 5
		...
		Vehicles = {
			{
				Spawner = vector3(330.16, -2041.47, 20.85),
				InsideShop = vector3(88.01, -1968.22, 20.64),
				SpawnPoints = {
					{coords = vector3(331.37, -2036.88, 21.01), heading = 292.05, radius = 6.0},
...
Config.Map = {
	{name="~p~Quartier Vagos",color=28, id=378,x= 326.0007, y = -2032.8780, z= 20.45}
  }